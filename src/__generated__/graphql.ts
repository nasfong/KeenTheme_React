...
export type CreateMenuParentMutation = {
  createMenuParent: { id: string; name: string; order?: number | null }
}
...
export type UpdateMenuParentMutation = {
  updateMenuParent?: { id: string; name: string; order?: number | null } | null
}
...
export type GetAllMenuParentsQuery = {
  getAllMenuParents: Array<{ id: string; name: string; order?: number | null }>
}
...
export type GetPermissionDropdownQueryVariables = Exact<{
  [key: string]: never
}>
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'MenuInput' },
          },
        },
      ],
      selectionSet: {
...
export const CreateMenuParentDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'createMenuParent' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'MenuParentInput' },
          },
        },
      ],
      selectionSet: {
  ...
  CreateMenuParentMutation,
  CreateMenuParentMutationVariables
>
export const UpdateMenuParentDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'updateMenuParent' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
export const DeleteMenuParentDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'deleteMenuParent' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
  ...
  DeleteMenuParentMutation,
  DeleteMenuParentMutationVariables
>
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'RoleInput' },
          },
        },
      ],
      selectionSet: {
...
export const GetAllMenusDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getAllMenus' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<GetAllMenusQuery, GetAllMenusQueryVariables>
export const GetAllMenuParentsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getAllMenuParents' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  GetAllMenuParentsQuery,
  GetAllMenuParentsQueryVariables
>
export const GetAllSideMenusDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getAllSideMenus' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'getAllSideMenus' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<
  GetAllSideMenusQuery,
  GetAllSideMenusQueryVariables
>
export const GetPermissionDropdownDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getPermissionDropdown' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  GetPermissionDropdownQuery,
  GetPermissionDropdownQueryVariables
>
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'thumbsUp' } },
                { kind: 'Field', name: { kind: 'Name', value: 'thumbsDown' } },
              ],
            },
          },
        ],
...
export const GetRoleDropdownDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getRoleDropdown' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'getRoleDropdown' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<
  GetRoleDropdownQuery,
  GetRoleDropdownQueryVariables
>
